...
def join_data(
    df_fujimori: pl.DataFrame,
    df_silso: pl.DataFrame,
) -> pl.DataFrame:
    df = (
        df_fujimori.lazy()
        .select("date", "total")
...
def draw_sunspot_number_whole_disk_plotly(df: pl.DataFrame) -> go.Figure:
    return (
        ...
        .update_layout(
            {
                "title": {
                    "text": "fujimori's whole-disk sunspot number",
                },
                "xaxis": {
                    "title": {
                        "text": "date",
...
def draw_sunspot_number_hemispheric_plotly(df: pl.DataFrame) -> go.Figure:
    return (
        ...
        .update_layout(
            {
                "title": {
                    "text": "fujimori's hemispheric sunspot number",
                },
                "xaxis": {
                    "title": {
                        "text": "date",
...
def draw_diff_plotly(df: pl.DataFrame) -> go.Figure:
    return (
        ...
        .update_layout(
            {
                "title": {
                    "text": "difference: fujimori* - silso",
                },
                "xaxis": {
                    "title": {
                        "text": "date",
