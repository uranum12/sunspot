...
@pytest.mark.parametrize(
    ...
    [(1956, 2, 18, date(1956, 2, 18)), (1972, 7, 30, date(1972, 7, 30))],
)
def test_calc_date(
    in_year: int, in_month: int, in_date: int, out_date: date
) -> None:
    df_in = pl.LazyFrame({"date": [in_date]}, schema={"date": pl.UInt8})
